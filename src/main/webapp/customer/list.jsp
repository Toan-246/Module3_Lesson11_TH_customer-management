...
<div class="container">
    ...
    <a class="btn btn-info float-end" href="/customers?action=create">Tạo khách hàng mới</a>
    <table class="table table-bordered">
        ...
        <c:forEach var="customer" items="${listCustomer}">
            <tr>
                ...
                <td><a class="btn btn-info" href="/customers?action=edit&id=${customer.id}"><i class="fas fa-edit"></i></a></td>
